...
public class SleepingActivity extends FragmentActivity implements LocationListener {
    ...
    // URL del WebService
    private static final String SERVICE_URL = "http://www.zaragoza.es/georref/json/hilo/ver_Alojamiento";
    ...
    void creaMarcadoresData(String json) throws JSONException {
        ...
        googleMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
			...
			public void onInfoWindowClick(Marker marker) {
				// TODO Auto-generated method stub
	            DialogAddPlace addPlaceDialog = new DialogAddPlace(SleepingActivity.this, false, true);

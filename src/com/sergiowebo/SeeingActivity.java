...
public class SeeingActivity extends FragmentActivity implements LocationListener {
    ...
    // URL del WebService
    private static final String SERVICE_URL = "http://www.zaragoza.es/georref/json/hilo/ver_Monumento";
    ...
    void creaMarcadoresData(String json) throws JSONException {
        ...
        googleMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
			...
			public void onInfoWindowClick(Marker marker) {
				// TODO Auto-generated method stub
	            DialogAddPlace addPlaceDialog = new DialogAddPlace(SeeingActivity.this, false, true);
	...
	public boolean onOptionsItemSelected(MenuItem item) {	
		switch(item.getItemId()){
			...
			case R.id.menu_posicion:
                ...
                String provider = locationManager.getBestProvider(criteria, true);
                Location location = locationManager.getLastKnownLocation(provider);
				Toast.makeText(SeeingActivity.this, 
